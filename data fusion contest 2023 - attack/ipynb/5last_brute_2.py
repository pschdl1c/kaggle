...
if __name__ == '__main__':
    ...
    hero_users_top = pred.loc[(pred.target_true == 1)].sort_values('target')[-10:].user_id.values
    poor_users_top = pred.loc[(pred.target_true == 0)].sort_values('target')[:10].user_id.values
    ...
    attacked_path = 'last_brute_split_2.csv'
